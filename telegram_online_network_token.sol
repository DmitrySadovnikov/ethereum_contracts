...
/// @title  Telegram Online Network token presale - telegram.org (TON) - crowdfunding code
/// Community: https://t.me/TONcommunity
///
...
contract TelegramOnlineNetworkToken {
  ...
  function TelegramOnlineNetworkToken() public {
    owner = msg.sender;
  }
